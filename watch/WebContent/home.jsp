...
.jumbotron {
	...
	<center>
		...
		<button type="button" class="btn btn-link">Cart</button>
	</center>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<center>
					<img src="images/ig6.jpg" alt="watch" width="460" height="345">
				</center>
			</div>

			<div class="item">
				<center>
					<img src="images/img7.jpg" alt="watch" width="460" height="345">
				</center>
			</div>
			<div class="item">
				<center>
					<img src="images/img10.jpg" alt="watch" width="460" height="345">
				</center>
			</div>
			<div class="item">
				<center>
					<img src="images/img11.jpg" alt="watch" width="460" height="345">
				</center>
			</div>
		</div>
