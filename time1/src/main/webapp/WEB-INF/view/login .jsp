...
<center><a href="home.jsp" class="btn btn-default">Home</a>
...
<a href="cart.jsp" class="btn btn-default">cart</a>
 ...
 <h2>Login Page</h2>
  <form class="form-horizontal" role="form" action=Loginservlet method="POST">
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="user" placeholder="Enter userid">
    </div>
    <div class="form-group">
